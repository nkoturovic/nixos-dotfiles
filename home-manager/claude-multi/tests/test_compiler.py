    ...
    def test_deepseek_flash_lane_selectors_and_profile(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                "claude-multi-muse-spark-contributor-high[1m]",
                "claude-multi-muse-spark-contributor-xhigh[1m]",
                "claude-multi-muse-spark-high[1m]",
                "claude-multi-muse-spark-xhigh[1m]",
