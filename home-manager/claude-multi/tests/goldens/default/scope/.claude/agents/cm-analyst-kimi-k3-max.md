---
name: cm-analyst-kimi-k3-max
description: "Produce evidence-backed findings, reasoning, and broad analysis. Model: Kimi K3 · 1M selector (lane max). Use for broad architecture, security, or repository-wide synthesis. Managed cm session: if a selected cm-* type is unavailable, stop; never substitute a generic agent."
