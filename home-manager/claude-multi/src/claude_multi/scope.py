...
def _lifecycle_settings(
    managed_id: str, hook_command: str, launch_epoch: int = 0
) -> dict[str, Any]:
...
def compile_scope(
    ...
    *,
    ...
    if managed_id is not None or hook_command is not None:
        ...
        settings.update(_lifecycle_settings(managed_id, hook_command, launch_epoch))
...
def compile_ordinary_scope(
    *,
    ...
    settings: dict[str, Any] = {
        ...
        **_lifecycle_settings(managed_id, hook_command, launch_epoch),
    }
    unknown = sorted(set(settings) - COMPILED_SETTINGS_KEYS)
    if unknown:
        raise ScopeError(
