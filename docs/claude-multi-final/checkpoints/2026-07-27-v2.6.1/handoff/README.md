# Checkpoint 2026-07-27 · claude-multi v2.6.1 — START HERE

You are picking up the claude-multi project at its 2026-07-27 **v2.6.1**
checkpoint: **activated (HM gen 104), doctor Ready with zero Attention
...
and the update flow proven end-to-end against a real candidate.**
Supersedes
...
- **Source:** `/home/kotur/personal/nixos-dotfiles` branch `feature/term-only`
  (series through `a4c2a83` + the activation commit; nothing pushed).
- **Activated:** Home Manager generation **104**; entrypoints report
  `2.6.1`. Rollback: gen 103/102.
