...
| --- | --- | --- |
| `2026-08-21-v2.20.0` (**current**) | claude-multi 2.20.0/catalog20 (HM gen 130): fail-closed final outbound `prompt_cache_retention` boundary for every current managed non-Claude route; official Anthropic/OpenAI-platform preservation; doctor Ready | [handoff/README.md](2026-08-21-v2.20.0/handoff/README.md) |
| `2026-08-19-v2.19.0` | claude-multi 2.19.0/catalog19 (HM gen 129): DeepSeek V4 Pro GA + Grok 4.6 exact slug; Pro max and Grok high/xhigh streaming calls accepted; complete failed-call rollback drill proven; obsolete retired-sol record forgotten by operator choice; doctor Ready | [handoff/README.md](2026-08-19-v2.19.0/handoff/README.md) |
