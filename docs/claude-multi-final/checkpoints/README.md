...
| `2026-07-27-v2.6.2` (**current**) | claude-multi 2.6.2 (HM gen 105): fork lifecycle operable, durable gateway routing, update flow proven live, adversarially hardened (D37); pin 2.1.220; doctor Ready, zero Attention | [handoff/README.md](2026-07-27-v2.6.2/handoff/README.md) |
