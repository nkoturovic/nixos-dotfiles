...
| --- | --- | --- |
| `2026-08-12-v2.17.0` (**current**) | claude-multi 2.17.0 (HM gen 124): DeepSeek + OpenRouter providers (flash 1M, grok45 500K grok profile), descriptor listing, D55 multi-route convention, D56 sol codex-route correction (372K→258.4K); probes green; doctor Ready | [handoff/README.md](2026-08-12-v2.17.0/handoff/README.md) |
