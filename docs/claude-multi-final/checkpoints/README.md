...
| --- | --- | --- |
| `2026-08-18-v2.18.0` (**current**) | claude-multi 2.18.0 (HM gen 125): sol joins the 1M class on the codex route (D57/023; acceptance probe green — 343,541 input tokens); retired-profile-aware doctor hint; doctor Ready | [handoff/README.md](2026-08-18-v2.18.0/handoff/README.md) |
