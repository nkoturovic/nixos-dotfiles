...
Status: **2.6.2 activated** (2026-07-27, HM gen 105; Opus 5 default lead; fork lifecycle operable; durable gateway routing; update flow proven live; adversarially hardened (D37); Claude 2.1.220 pinned; doctor Ready).
